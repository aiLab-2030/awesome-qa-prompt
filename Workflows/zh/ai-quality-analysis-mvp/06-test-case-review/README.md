...
[English](../../../en/ai-quality-analysis-mvp/06-test-case-review/README.md) | 简体中文
...
- 必需：需求、需求分析、测试策略、测试策略评审报告，以及有明确版本的测试用例集
- 可选：技术方案、代码评审报告

正式评审前必须对齐各 Artifact 的名称、版本、来源和可读范围。测试用例内容不可读、版本不明确，或必需上游材料缺失/冲突到无法判断预期时，角色只输出阻塞与信息缺口，不猜测用例内容或产品/技术事实。
