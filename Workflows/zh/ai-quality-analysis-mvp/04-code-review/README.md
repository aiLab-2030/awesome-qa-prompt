...
[English](../../../en/ai-quality-analysis-mvp/04-code-review/README.md) | 简体中文
...
- 必需：明确的代码版本，以及该版本对应的 Diff、补丁、完整文件内容或可读取仓库位置
- 推荐：需求和需求分析
- 可选：技术方案

仅有需求、文件名、目录名、提交说明或口头描述不等于可读取代码。任何角色或汇总 Prompt 无法读取明确代码版本及对应代码内容时，都必须停止评审，只报告阻塞原因和所需输入，不猜测实现。
